        ...
        <div className='w-full'>
            ...
            <div className='w-full px-40 py-20 '>
                <div className='flex justify-center items-center gap-5'>
                    <div className='border border-gray-300 w-[570px] h-[370px] bg-navyBlue rounded-md relative'>
                        <Image src={"/about.png"} width={555} height={390} className='rounded-md absolute -top-1 -right-4' alt='about' />
                    </div>
                    <div className='flex flex-col items-start justify-start w-[550px] pl-10'>
            ...
            <div className='py-20 px-40 w-full bg-[#FBFBFF]'>
                ...
                <div className='flex-col flex justify-center items-center py-10'>
                    ...
                    <p className='font-bold font-lato text-center text-gray-500 w-[690px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non duis ultrices quam vel dui sollicitudin aliquet id arcu. Nam vitae a enim nunc, sed sapien egestas ac nam. Tristique ultrices dolor aliquam lacus volutpat praesent.</p>
                </div>
