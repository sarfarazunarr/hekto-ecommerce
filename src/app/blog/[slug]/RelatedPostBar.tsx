...
const RelatedPostBar = () => {
    return (
        <div className='w-full p-5 rounded-md shadow-md shadow-gray-300 flex justify-start items-center gap-2'>
            <Image src={"/image1.png"} width={103} height={104} alt='blog' className='rounded-md' />
