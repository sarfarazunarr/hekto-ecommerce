...
const PromotedProduct = () => {
  return (
    <div className='w-full h-[570px] px-40 py-10 flex justify-center items-center gap-10 bg-skyBlue'>
      <Image src={"/sofa.png"} alt='sofa' width={500} height={500} />
      <div className='flex flex-col gap-5'>
        <h2 className='text-4xl font-bold font-josefin-sans text-navyBlue'>Unique Features Of leatest & Trending Poducts</h2>
